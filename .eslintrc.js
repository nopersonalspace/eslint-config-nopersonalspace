 ...
 * @see https://www.npmjs.com/package/eslint-plugin-jsdoc#user-content-eslint-plugin-jsdoc-configuration
 */
const JSDOC_RULES = {
  require: {
...
module.exports = {
  ...
  extends: [
    "airbnb-base", // A good starting point
    "plugin:import/typescript", // Typescript stuff
    "plugin:@typescript-eslint/recommended", // Another good starting point
    "plugin:jsdoc/recommended", // JSDoc for code docs
    "plugin:react/recommended", // React starter
    "plugin:jsx-a11y/recommended", // Accessability
    "plugin:eslint-comments/recommended", // Comments best practices
    "prettier", // Prettier
    "next", // Support for Next.js
    "next/core-web-vitals", // Support for Next.js
  ],
  env: {
    browser: true,
    node: true,
  ...
  plugins: [
    "import", // Deal with ES6+ import syntax
    "react", // Provides ESLint rules for React-specific code
    "jsx-a11y", // Ensures accessibility best practices in JSX elements
    "react-hooks", // Enforces rules for React Hooks usage
    "simple-import-sort", // Sorts import statements in a consistent manner
    "unicorn", // Collection of rules for various best practices and improvements
  ],
  parserOptions: {
    ecmaVersion: 6,
    sourceType: "module",
  ...
  rules: {
    /// //////////////////////////////////////////////////////////////////
    // d8888b. d888888b .d8888.  .d8b.  d8888b. db      d88888b d8888b. //
    // 88  `8D   `88'   88'  YP d8' `8b 88  `8D 88      88'     88  `8D //
    // 88   88    88    `8bo.   88ooo88 88oooY' 88      88ooooo 88   88 //
    // 88   88    88      `Y8b. 88~~~88 88~~~b. 88      88~~~~~ 88   88 //
    // 88  .8D   .88.   db   8D 88   88 88   8D 88booo. 88.     88  .8D //
    // Y8888D' Y888888P `8888Y' YP   YP Y8888P' Y88888P Y88888P Y8888D' //
    /// //////////////////////////////////////////////////////////////////
    ...
    /** Prevent use of global variables. They're messy and lead to issues. */
    ...
    /// ///////////////////////////////////////////s//////////////////////////////
    // db   d8b   db  .d8b.  d8888b. d8b   db d888888b d8b   db  d888b  .d8888. //
    // 88   I8I   88 d8' `8b 88  `8D 888o  88   `88'   888o  88 88' Y8b 88'  YP //
    // 88   I8I   88 88ooo88 88oobY' 88V8o 88    88    88V8o 88 88      `8bo.   //
    // Y8   I8I   88 88~~~88 88`8b   88 V8o88    88    88 V8o88 88  ooo   `Y8b. //
    // `8b d8'8b d8' 88   88 88 `88. 88  V888   .88.   88  V888 88. ~8~ db   8D //
    // `8b8' `8d8'  YP   YP 88   YD VP   V8P Y888888P VP   V8P  Y888P  `8888Y'  //
    /// //////////////////////////////////////////////////////////////////////////

    /** Interfaces > Types. Sorry haters */
  ...
  overrides: [
    /// ////////////////////////////////////////////////////////////////////////////
    //  .d88b.  db    db d88888b d8888b. d8888b. d888888b d8888b. d88888b .d8888. //
    // .8P  Y8. 88    88 88'     88  `8D 88  `8D   `88'   88  `8D 88'     88'  YP //
    // 88    88 Y8    8P 88ooooo 88oobY' 88oobY'    88    88   88 88ooooo `8bo.   //
    // 88    88 `8b  d8' 88~~~~~ 88`8b   88`8b      88    88   88 88~~~~~   `Y8b. //
    // `8b  d8'  `8bd8'  88.     88 `88. 88 `88.   .88.   88  .8D 88.     db   8D //
    //  `Y88P'     YP    Y88888P 88   YD 88   YD Y888888P Y8888D' Y88888P `8888Y' //
    /// ////////////////////////////////////////////////////////////////////////////
    /**
    ...
    /**
     * Here we define the order of imports when auto sorted
     */
    {
      files: ["*.ts"],
      rules: {
        "simple-import-sort/imports": [
          "error",
          {
            groups: [
              ...
              ["^"],
              // @main, @/, and ~/ imports. These should cover most projects, but if your
              // path alias is custom then some config might be needed
              ["^@main/"],
              ["^@/"],
              ["^~/"],
              // Relative imports.
